...
async function main() {
  ...
  if (!conn) {
    throw new Error("POSTGRES_URL, POSTGRES_PRISMA_URL, or DATABASE_URL must be configured");
  }
  ...
  console.log("Neon storage initialized: bookings + site_content tables are ready.");
}
